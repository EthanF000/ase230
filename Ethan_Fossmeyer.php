<?php
	...
	$workTitle1 = 'Help Desk Technician';
	$workSummary1  = 'Providing excellent enterprise IT support to executive customers as well as being the lead of ActiveDirectory account creations and maintenance. Regularly involved in typical and atypical software and hardware problem-solving endeavors.';
	$workKeyAchievement = 'Designed and implemented a documentation flow using Power Automate, resulting in a measured 30% boost to overall worker productivity.';
	$workTitle2 = 'Museum Host';
	$workSummary2 = 'Serving thousands of guests daily out of the many food venues that the Creation Museum owns and operates. Regular top-performer in employee efficiency metrics such as: positive guest interactions, least difference in register cashout tills, and employee of the month awards.';
	$workCompany = 'Answers in Genesis';
?>
...
<body>
						    ...
						    <div class="resume-section-content">
							    <div class="resume-timeline position-relative">
								    <article class="resume-timeline-item position-relative pb-5">
									    ...
									    <div class="resume-timeline-item-header mb-2">
										    <div class="d-flex flex-column flex-md-row">
										        <h3 class="resume-position-title font-weight-bold mb-1"><?php echo $workTitle1 ?></h3>
										        <div class="resume-company-name ms-auto"><?php echo $workCompany ?></div>
										    </div><!--//row-->
										    <div class="resume-position-time"><?php echo '2022 - Present' ?></div>
									    </div><!--//resume-timeline-item-header-->
									    <div class="resume-timeline-item-desc">
										    <p><?php echo $workSummary1 ?></p>
										    <h4 class="resume-timeline-item-desc-heading font-weight-bold"><?php echo 'Key Achievement:'?></h4>
										    <ul>
											    <li><?php echo $workKeyAchievement ?></li>
										    </ul>
										    <h4 class="resume-timeline-item-desc-heading font-weight-bold"><?php echo 'Technologies used:'?></h4>
										    <ul class="list-inline">
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'Windows/Linux/Mac'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'Power Automate'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'PowerShell'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'ActiveDirectory'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'ZenDesk'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'ManageEngine'?></span></li>
										    </ul>
								    ...
								    <article class="resume-timeline-item position-relative pb-5">
									    ...
									    <div class="resume-timeline-item-header mb-2">
										    <div class="d-flex flex-column flex-md-row">
										        <h3 class="resume-position-title font-weight-bold mb-1"><?php echo $workTitle2 ?></h3>
										        <div class="resume-company-name ms-auto"><?php echo $workCompany ?></div>
										    </div><!--//row-->
										    <div class="resume-position-time"><?php echo '2016 - 2022'?></div>
									    </div><!--//resume-timeline-item-header-->
									    <div class="resume-timeline-item-desc">
										    <p><?php echo $workSummary2 ?></p>
										    <h4 class="resume-timeline-item-desc-heading font-weight-bold"><?php echo 'Technologies used:'?></h4>
										    <ul class="list-inline">
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'Galaxy'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'Revel'?></span></li>
											    <li class="list-inline-item"><span class="badge bg-secondary badge-pill"><?php echo 'Windows'?></span></li>
										    </ul>
									    </div><!--//resume-timeline-item-desc-->
								    </article><!--//resume-timeline-item-->
							    </div><!--//resume-timeline-->
						    ...
						    <div class="resume-section-content">
						        ...
						        <div class="resume-skill-item">
						            ...
						            <ul class="list-inline">
							            ...
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo 'VSCode'?></span></li>
							            <li class="list-inline-item"><span class="badge badge-light"><?php echo 'IntelliJ IDEA'?></span></li>
						            </ul>
						        </div><!--//resume-skill-item-->
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled">
								    <li class="mb-2">
										...
										<div class="resume-degree-org"><?php echo 'with a Minor in Finance'?></div>
						    ...
						    <div class="resume-section-content">
							    <ul class="list-unstyled resume-awards-list">
								    <li class="mb-2 ps-4 position-relative">
								        ...
								        <div class="resume-award-name"><?php echo 'President\'s Honor List'?></div>
								        <div class="resume-award-desc"><?php echo 'Spring 2021, Fall 2021, and Spring 2022. For receiving a GPA of 4.0 in a semester.'?></div>
								    </li>
								    <li class="mb-0 ps-4 position-relative">
								        <i class="resume-award-icon fas fa-trophy position-absolute" data-fa-transform="shrink-2"></i>
								        <div class="resume-award-name"><?php echo 'Dean\'s List'?></div>
								        <div class="resume-award-desc"><?php echo 'Fall 2020, Fall 2022, and Spring 2023. For receiving a GPA of 3.5-3.99 in a semester.'?></div>
								    </li>
							    </ul>
						    </div>
					...
					<div class="row mt-4">
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-body">
									<h5 class="card-title"><?php echo 'PHP Resume'?>e</h5>
									<p class="card-text"><?php echo 'Resume created using PHP.'?></p>
									<a href="btn btn-outline-primary" href="#"><?php echo 'https://github.com/EthanF000/ase230'?></a>
								</div>
							</div>
						</div>
					</div>
    ...
    <footer class="footer text-center pt-2 pb-5">
        ...
        <small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart"></i> <?php echo $name ?></small>
    </footer>
